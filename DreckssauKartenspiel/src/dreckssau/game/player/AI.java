...
public class AI extends Player {
	...
	public int makeDecision(String possibleActions, String player, String hand, String round, String phase, String trickCards) {
		...
		if (this.difficulty == 3) {
			bestDecision = this.difficulty3(fActions, fHand, fTrickCards, fRound, fPhase, fPlayerNumber);
		}
	...
	private int difficulty3(ArrayList<Integer> fActions, ArrayList<Card> fHand, ArrayList<Card> fTrickCards, int fRound,
		...
		if (!fPhase) {
			...
			ArrayList<Card> sortedTricksCards = new ArrayList<>();
