...
//						this.getGamePhase(), this.roundNumber, this.round.getTrickCards()));
                if (round.phase.equals("TricksPhase")) {
                    out += round.placeNext(buffer.makeDecision(this.getPossibleActions(), this.getAllPlayers(), this
                            .getHand(), this.getRound(), this.getGamePhase(), this.getCardSetStatus()));
                } else {
                    out += round.placeNext(buffer.makeDecision(this.getPossibleActions(), this.getAllPlayers(), this
                            .getHand(), this.getRound(), this.getGamePhase(), null));
                }
            } else {
    ...
    private class Round {
         ...
         *
         * @param i number of the card/bid to place.
