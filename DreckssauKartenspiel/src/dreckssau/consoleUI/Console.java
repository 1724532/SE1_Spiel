...
public class Console {
    ...
    /**
     * The method which handles the UI during gameplay and manages the user
     * input and view presentation for the player.
     */
    ...
    private void getGameConfiguration() {
        ...
        if (inputNumber != null && !inputNumber.equals("") && inputNumber
                .matches("[2-4]")) {
        ...
        System.out.println("\n>>> Thank you, " + playerName + "! You entered all skill levels! Game is ready to " +
                "begin in... <<<");
...
//        }
    ...
    private void welcomeMessage() {
        ...
        System.out.println("----------------------------");
        System.out.println("You are able to play against 2 - 4 computer " + "players for which you define the " +
                "skill level!\n");
    ...
    private String getName() {
        ...
        if (inputName != null && !inputName.equals("") && inputName.length()
                <= 25)
            return inputName;
